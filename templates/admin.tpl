<div class="admin-container">
    <div class="container-950">
        ...
        </div> {* /.card /.playlist-enter-container *}
        ...
        <div class="stat-count-box">
            ...
            <div class="stat-listings">
                <div class="column-container col-contain-2">
                    <ol>
                        {foreach from=$most_played_songs item=result}
                        <li>
                            <span class="result-item"><span class="result-artist">{$result.artist}</span> - {$result.title}</span> - <span class="result-count">{$result.count} plays</span>
                        </li>
                        {/foreach}
                    </ol>
                </div>
        ...
        <div class="stat-count-box">
            ...
            <div class="stat-listings">
                <div class="column-container col-contain-4">
                    <ol>
                        {foreach from=$most_played_artists item=result}
                            <li>
